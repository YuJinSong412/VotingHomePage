...
@NamedNativeQuery(
    query = "select v.vote_seq, a.apart_name, v.vote_start_date, v.vote_end_date, v.vote_title, v.esm_voter, v.vote_state_cd from application a JOIN vote v ON a.vote_seq = v.vote_seq;",
